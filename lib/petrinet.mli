module Make :
  functor (P : Set.OrderedType) (T : Set.OrderedType) ->
    sig
      module Node :
        sig
      ...
      val bind_pset :
        ('a -> PlaceSet.t) -> 'a -> PlaceSet.t -> 'a -> PlaceSet.t
      val bind_p :
        ('a -> PlaceSet.t) -> 'a -> PlaceSet.elt -> 'a -> PlaceSet.t
      val bind_f :
        ('a -> PlaceSet.t) -> ('a -> PlaceSet.t) -> 'a -> PlaceSet.t
      val ( --> ) :
        PlaceSet.elt list ->
        PlaceSet.elt list -> 'a -> ('a -> PlaceSet.t) * ('a -> PlaceSet.t)
      val empty : unit -> t
      val of_lists :
        PlaceSet.elt list ->
        TransSet.elt list ->
      ...
      val of_sets :
        PlaceSet.t ->
        TransSet.t ->
        (T.t -> PlaceSet.t) -> (T.t -> PlaceSet.t) -> PlaceSet.t -> t
      val copy : t -> t
